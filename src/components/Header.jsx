  ...
  return (
    <div className='bg-[#1c2430] min-h-screen relative ff-sarabun flex flex-col justify-center items-center'>
      ...
      <div className="container max-w-[1140px] mx-auto px-4 flex justify-between items-center ">
        ...
        <a href="/" className="text-white font-normal text-[21.64px] leading-[113%] z-10 pt-7 pb-[30px] ">
          NEKOZUMA
        </a>
        ...
        >
          {NAV.map((obj, index) => (
            <li key={index} className="flex-shrink-0">
              <a
                onClick={handleClick}
                href={obj.link}
                className="text-white font-normal  text-base leading-[130%] transition-transform delay-150 duration-300 ease-in-out hover:scale-150 inline-block link-hover"
              >
                {obj.title}
              </a>
            </li>
          ...
          <ul className='flex gap-[18px] justify-center items-center'>
            <li className='flex-shrink-0'><a className='transition-transform delay-150 duration-300 ease-in-out hover:scale-150 inline-block' href=""><img src={discord} alt="discord" /></a></li>
            <li className='flex-shrink-0'><a className='transition-transform delay-150 duration-300 ease-in-out hover:scale-150 inline-block' href=""><img src={twitter} alt="twitter" /></a></li>
          </ul>
        </ul>
        ...
        <div className="container max-w-[1140px] mx-auto px-3  z-[5]">
          <div className="flex flex-wrap  flex-row px-[-12px] items-center">
            ...
            <div className='w-full lg:w-1/2 px-3 mt-[50px] lg:mt-0'>
              ...
              <h1 className='text-[#3586FF] font-normal text-[45px] text-center lg:text-start  md:text-[64px] leading-[113%] mb-[11px] text-main '>NEKOZUMA
              </h1>
              ...
              <button className='font-normal text-base leading-[130%] text-white py-2 px-6 rounded-[9px] bg-[#245AAB] transition-transform delay-150 duration-300 ease-in-out hover:scale-120'>Connect Wallet</button>
              </div>
            </div>
